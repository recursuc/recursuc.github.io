...
/*
Script: Array.js
	Contains Array prototypes, <$Array>, <$each>
...
Example:
	(start code)
	function myFunction(){
		$Array(arguments).each(argument, function(){
			alert(argument);
		});
	};
...
Element.extend({
	...
	*/
	...
	clone: function(contents){
		...
		for (var type in this.$events) el.$events[type] = {
			'keys': $Array(this.$events[type].keys),
			'values': $Array(this.$events[type].values)
		};
	...
	*/
	...
	hasChild: function(el){
		return !!$Array(this.getElementsByTagName('*')).contains(el);
	},
	...
	*/
	...
	setHTML: function(){
		this.innerHTML = $Array(arguments).join('');
		return this;
	},
